...
import edu.illinois.cs.cogcomp.lbjava.util.*;
...
/**
  * Use this class to batch train a {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner}.
  *
  * @author Nick Rizzolo
 **/
public class BatchTrainer
{
  ...
  /** <!-- preExtract(String) -->
    ...
    * lexicon.  If it doesn't, call {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#setLexiconLocation(String)}
    * or {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#setLexiconLocation(java.net.URL)} on that object
  ...
  /** <!-- preExtract(String,Lexicon.CountPolicy) -->
    ...
    * {@link #preExtract(String,boolean, edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.CountPolicy)} with the second
  ...
  /** <!-- pruneDataset(String,Lexicon.PruningPolicy,Learner) -->
    ...
    * is a {@link edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser}.  This condition is easy to
    * satisfy, since the
    * {@link #preExtract(String,boolean, edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.CountPolicy)} method will
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#setLexiconLocation(String)} or
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#setLexiconLocation(java.net.URL)} on that object before
    * calling this method.
    *
    * <p> Calling this method is equivalent to calling
    * {@link #pruneDataset(String,boolean, edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.PruningPolicy, edu.illinois.cs.cogcomp.lbjava.learn.Learner)} with
  ...
  /** <!-- pruneDataset(String,boolean,Lexicon.PruningPolicy,Learner) -->
    ...
    *
    * <p> When calling this method, it must be the case that {@link #parser}
    * is an {@link edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser ArrayFileParser}.  This
  ...
  /** <!-- interface DoneWithRound -->
    ...
    * supplements the processing in {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#doneWithRound()} which is
  ...
  /** <!-- crossValidationTesting(FoldParser,TestingMetric,boolean,boolean) -->
    ...
    *         fraction) if the testing metric is {@link edu.illinois.cs.cogcomp.lbjava.learn.Accuracy}.
   **/
  ...
  /** <!-- tune(Learner.Parameters[],int[],int,FoldParser.SplitPolicy,double,TestingMetric) -->
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner.Parameters} objects and an array of rounds.
    * As such, the value in the {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner.Parameters#rounds}
    * field is ignored during tuning.  It is also overwritten in each of the
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner.Parameters} objects when the optimal number of
  ...
  /** <!-- testMidTraining(Parser,TestingMetric,boolean) -->
    ...
    *         metric is {@link edu.illinois.cs.cogcomp.lbjava.learn.Accuracy}.
   **/
