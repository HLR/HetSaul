...
public abstract class Feature implements Cloneable, Comparable, Serializable
{
  ...
  /**
    ...
    *
    * @see #readFeature(edu.illinois.cs.cogcomp.lbjava.util.ExceptionlessInputStream)
   **/
  protected Feature() { }
  ...
  /**
    ...
    * -1)</code>.
    *
    * @see #getFeatureKey(edu.illinois.cs.cogcomp.lbjava.learn.Lexicon,boolean,int)
  ...
  /**
    * Returns a {@link edu.illinois.cs.cogcomp.lbjava.classify.RealFeature} whose value is the strength of the current
