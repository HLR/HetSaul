...
/**
  * Extend this class to create a new {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier} that learns to mimic
...
public abstract class Learner extends Classifier
{
  ...
  /** Stores the feature {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon}. */
  protected Lexicon lexicon;
  /** Stores the label {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon}. */
  ...
  /**
    ...
    * {@link #readLexiconOnDemand(java.net.URL)} has already been called, in which case
  ...
  /**
    ...
    * This implementation simply calls {@link #learn(edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector)} on each
  ...
  /**
    ...
    * those decisions as {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s in a vector.
    *
    * @param example  The object to make decisions about.
    * @return A vector of {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s about the input object.
   **/
  ...
  /**
    ...
    * returning those decisions as {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s in a vector.
    *
    * @param vector The vector to make decisions about.
    * @return A vector of {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s about the input vector.
   **/
  ...
  /**
    ...
    * (simply calling {@link #classify(edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector)} repeatedly) and should
  ...
  /**
    ...
    * feature instead of a {@link edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector}.
    *
  ...
  /**
    ...
    * not create {@link edu.illinois.cs.cogcomp.lbjava.classify.RealFeature}s in {@link #predictions} since their
    * strengths cannot be modified.  In association with
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscreteFeature}s it creates a
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscretePrimitiveStringFeature} with an empty identifier.  Its
    * <code>value</code>, <code>valueIndex</code>, and
    * <code>totalValues</code> fields are filled by calling the label
    * feature's {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature#getStringValue() getStringValue()},
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature#getValueIndex() getValueIndex()}, and
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature#totalValues() totalValues()} methods respectively.
    *
  ...
  /**
    ...
    * {@link #write(edu.illinois.cs.cogcomp.lbjava.util.ExceptionlessOutputStream)}.
    *
  ...
  /**
    ...
    * {@link #readLexiconOnDemand(java.net.URL)}.
    *
  ...
  /**
    * Serializes a {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner.Parameters} object to the specified file.
    *
  ...
  /**
    * Deserializes a {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner.Parameters} object out of the specified
    * locaiton.
    *
