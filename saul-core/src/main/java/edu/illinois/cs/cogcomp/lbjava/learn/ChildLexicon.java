...
/**
  ...
  * learner's weight vector.  While a {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon} will store an instance
  * of this class in its {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon#lexiconChildren} field, an instance of
  * this class will never do so.  Also, the {@link #lookupChild(edu.illinois.cs.cogcomp.lbjava.classify.Feature)}
...
public class ChildLexicon extends Lexicon
{
  ...
  /**
    ...
    * {@link #childLexiconLookup(edu.illinois.cs.cogcomp.lbjava.classify.DiscreteConjunctiveFeature,int)} that
  ...
  /**
    * Unlike the overridden method in {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon}, this method simply
