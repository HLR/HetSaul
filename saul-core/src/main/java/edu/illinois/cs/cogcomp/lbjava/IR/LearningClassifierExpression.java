...
public class LearningClassifierExpression extends ClassifierExpression
{
 ...
 /**
   * A list of the {@link edu.illinois.cs.cogcomp.lbjava.IR.ParameterSet} objects that appear in
   * the argument list.
  **/
 ...
 /**
   * The {@link edu.illinois.cs.cogcomp.lbjava.SemanticAnalysis} pass will let this
   ...
   * enclosing {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierAssignment} by setting this flag.
  **/
 ...
 /**
   ...
   *                   found.
  **/
 public LearningClassifierExpression(ClassifierExpression l, LinkedList<Clause> cl,
 ...
 /**
   ...
   * {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression}.  Note that this class is not an
   * {@link edu.illinois.cs.cogcomp.lbjava.IR.ASTNode} since it is only an intermediary used during parsing.
   *
   * @author Nick Rizzolo
 **/
