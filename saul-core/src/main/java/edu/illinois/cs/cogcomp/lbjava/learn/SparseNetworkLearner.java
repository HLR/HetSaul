...
/**
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit}s to make a multi-class classification.
  * Any {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit} may be used, so long as it implements its
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseNetworkLearner.Parameters Parameters} as input.
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseNetworkLearner.Parameters Parameters} class
...
/** Default for {@link #baseLTU}. */
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseNetworkLearner.Parameters} object.
    *
  ...
  /** Simply calls {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#doneWithRound()} on every
      LTU in the network. */
  ...
  /**
    ...
    * there is no {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit} associated with a given label
    * from the collection, that label's score in the returned {@link edu.illinois.cs.cogcomp.lbjava.classify.ScoreSet}
  ...
  /**
    ...
    * {@link #scores(int[],double[], java.util.Collection)} when the labeler is known to
  ...
  /**
    ...
    *
    * @see   edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#scores(Object)
    * @param exampleFeatures  The example's array of feature indices.
    * @param exampleValues    The example's array of feature values.
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseNetworkLearner}'s
  ...
  public static class Parameters extends Learner.Parameters
  {
	...
	/**
      ...
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseNetworkLearner#defaultBaseLTU}.
     **/
