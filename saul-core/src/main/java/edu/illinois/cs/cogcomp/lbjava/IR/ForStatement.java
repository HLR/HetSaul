...
public class ForStatement extends Statement
{
  ...
  /** Returns a hash code for this {@link edu.illinois.cs.cogcomp.lbjava.IR.ASTNode}. */
  public int hashCode() {
  ...
  /**
    * Distinguishes this {@link edu.illinois.cs.cogcomp.lbjava.IR.ASTNode} from other objects according to its
