...
/**
  ...
  * {@link learn.MuxLearner.Parameters Parameters} as input.  The
  ...
  * {@link learn.MuxLearner.Parameters Parameters} class indicates the
...
public class MuxLearner extends Learner
{
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.MuxLearner.Parameters} object.
    *
  ...
  /**
    ...
    *
    * @see   edu.illinois.cs.cogcomp.lbjava.learn.Learner#scores(Object)
    * @param exampleFeatures  The example's array of feature indices.
    * @param exampleValues    The example's array of feature values.
   **/
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.MuxLearner}'s configurable
  ...
  public static class Parameters extends Learner.Parameters
  {
    ...
    /**
      * This string is returned during testing when the multiplexed
      * <code>Learner</code> doesn't exist; default
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.MuxLearner#defaultDefaultPrediction}.
     **/
