...
/**
  * A <code>LinearThresholdUnit</code> is a {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner} for binary
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier#allowableValues()} method.  The first value returned
  * from {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier#allowableValues()} is treated as "negative", and it
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit.Parameters Parameters} as input.
...
public abstract class LinearThresholdUnit extends Learner
{
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#defaultThreshold}.
   **/
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit.Parameters} object.
...
//    System.out.println("Promote?" + shouldPromote(label, s, threshold, positiveThickness));
//    System.out.println("Demote?" + shouldDemote(label, s, threshold, positiveThickness));
...
//    System.out.println("rate:" + learningRate);
  ...
  /**
    ...
    * and returns a {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscretePrimitiveStringFeature} set to either the
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit}'s configurable
  ...
  public static class Parameters extends Learner.Parameters
  {
    /**
      * The rate at which weights are updated; default
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#defaultLearningRate}.
     **/
    ...
    /**
      * The weight associated with a feature when first added to the vector;
      * default {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#defaultInitialWeight}.
     **/
    ...
    /**
      ...
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#defaultThickness}.
     **/
