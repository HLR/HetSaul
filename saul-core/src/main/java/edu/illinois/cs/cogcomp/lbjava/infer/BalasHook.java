...
/**
  * This {@link edu.illinois.cs.cogcomp.lbjava.infer.ILPSolver} implements Egon Balas' zero-one ILP solving
...
public class BalasHook extends ZeroOneILPProblem implements ILPSolver
{
  ...
  /**
    * Verbosity level.  {@link edu.illinois.cs.cogcomp.lbjava.infer.ILPInference#VERBOSITY_NONE} produces no
    * incidental output.  If set to {@link edu.illinois.cs.cogcomp.lbjava.infer.ILPInference#VERBOSITY_LOW}, only
    * variable and constraint counts are reported on <code>STDOUT</code>.  If
    * set to {@link edu.illinois.cs.cogcomp.lbjava.infer.ILPInference#VERBOSITY_HIGH}, a textual representation of
  ...
  /**
    * Simply overrides
    * {@link edu.illinois.cs.cogcomp.lbjava.infer.ZeroOneILPProblem#addConstraint(int[],double[],int,double)} so
    * that it calls
    * {@link edu.illinois.cs.cogcomp.lbjava.infer.ZeroOneILPProblem#addConstraint(int[],double[],double)} thereby
