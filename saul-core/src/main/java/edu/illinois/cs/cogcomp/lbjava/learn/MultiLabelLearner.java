...
/**
  ...
  * examples.  A separate {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit} is learned independently
  * to predict whether each label is appropriate for a given example.  Any
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit} may be used, so long as it implements its
  ...
  * separate feature for each {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit} whose score on the
...
public class MultiLabelLearner extends SparseNetworkLearner
{
  /**
    ...
    * algorithm: {@link edu.illinois.cs.cogcomp.lbjava.learn.SparsePerceptron}.
   **/
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.MultiLabelLearner.Parameters} object.
    *
  ...
  /**
    * Returns a separate feature for each {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit} whose
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.MultiLabelLearner}'s configurable
