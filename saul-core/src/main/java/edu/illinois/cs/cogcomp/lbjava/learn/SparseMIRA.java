...
/**
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseNetworkLearner} does.  However, updates to these weight
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseMIRA.Parameters Parameters} as input.
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseMIRA.Parameters Parameters} class
...
public class SparseMIRA extends Learner
{
  ...
  /**
    ...
    * there is no {@link edu.illinois.cs.cogcomp.lbjava.learn.BiasedRandomWeightVector} associated with a given
    * label from the collection, that label's score in the returned
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.ScoreSet} will be set to <code>Double.NEGATIVE_INFINITY</code>.
    *
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseMIRA}'s
