...
/**
  ...
  * operates very similarly to {@link edu.illinois.cs.cogcomp.lbjava.learn.SparsePerceptron} with a thick
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#learningRate} will be used.  When the weight
  * vector did not make a mistake, {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#learningRate} is
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.BinaryMIRA.Parameters Parameters} as input.
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.BinaryMIRA.Parameters Parameters} class
...
public class BinaryMIRA extends SparsePerceptron {
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.BinaryMIRA.Parameters} object.
    *
  ...
  /**
    ...
    * an alternative subclass of {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector}.
    *
    * @param n The name of the classifier.
    * @param r The desired learning rate.
    * @param B The desired beta value.
  ...
  /**
    ...
    * and finally {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#bias}.
    *
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.BinaryMIRA}'s configurable
