...
/**
  * A <code>Lexicon</code> contains a mapping from {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s to
  * integers.  The integer key of a feature is returned by the
  * {@link #lookup(edu.illinois.cs.cogcomp.lbjava.classify.Feature)} method.  If the feature is not already in the
...
public class Lexicon implements Cloneable, Serializable
{
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#setLexicon(edu.illinois.cs.cogcomp.lbjava.learn.Lexicon)}.
   **/
  ...
  /** <!-- countFeatures(CountPolicy) -->
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.CountPolicy#none}, and the latter happens when
    * <code>policy</code> is {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.CountPolicy#none}.
    *
    * @see #lookup(edu.illinois.cs.cogcomp.lbjava.classify.Feature,boolean)
  ...
  /** <!-- lookup(Feature) -->
    ...
    * See {@link #lookup(edu.illinois.cs.cogcomp.lbjava.classify.Feature,boolean,int)} for more details.
    *
    * @param f  The feature to look up.
  ...
  /** <!-- lookup(Feature,boolean) -->
    ...
    * -1)</code>.  See {@link #lookup(edu.illinois.cs.cogcomp.lbjava.classify.Feature,boolean,int)} for more details.
    *
    * @param f        The feature to look up.
  ...
  /** <!-- lookupKey(int) -->
    * Does a reverse lexicon lookup and returns the {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature} associated
  ...
  /** <!-- isPruned(int,PruningPolicy) -->
    ...
    *
    * @see #isPruned(int,int, edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.PruningPolicy)
  ...
  /** <!-- isPruned(int,int,PruningPolicy) -->
    ...
    * {@link #prune(edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.PruningPolicy)}.  Passing a non-negative label in
  ...
  /**
    ...
    * {@link #prune(edu.illinois.cs.cogcomp.lbjava.learn.Lexicon.PruningPolicy)} as well as all feature counts.
   **/
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(
        "usage: java edu.illinois.cs.cogcomp.lbjava.learn.Lexicon <lex file> [<package names = true>]");
      System.exit(1);
    }
