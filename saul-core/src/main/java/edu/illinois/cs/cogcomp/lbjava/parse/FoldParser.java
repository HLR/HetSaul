...
/**
  ...
  *
  * @see    edu.illinois.cs.cogcomp.lbjava.parse.FoldParser.SplitPolicy
...
public class FoldParser implements Parser
{
  ...
  /**
    ...
    *      appearance of the {@link edu.illinois.cs.cogcomp.lbjava.parse.FoldSeparator} in place of an example
    *      object.
    *   </dd>
    * </dl>
    * </blockquote>
