...
public class Accuracy implements TestingMetric
{
  /**
    ...
    * {@link #test(edu.illinois.cs.cogcomp.lbjava.classify.Classifier, edu.illinois.cs.cogcomp.lbjava.classify.Classifier, edu.illinois.cs.cogcomp.lbjava.parse.Parser)} is called.
   **/
