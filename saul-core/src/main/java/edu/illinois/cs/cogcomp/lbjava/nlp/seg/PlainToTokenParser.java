...
/**
  ...
  * consisting of {@link edu.illinois.cs.cogcomp.lbjava.nlp.seg.Token}s.  The input parser is actually expected to
  ...
  * The {@link edu.illinois.cs.cogcomp.lbjava.nlp.seg.Token}s returned by calls to this class's {@link #next()}
...
public class PlainToTokenParser implements Parser
{
  ...
  /**
    * This method returns {@link edu.illinois.cs.cogcomp.lbjava.nlp.seg.Token}s until the input is exhausted, at
