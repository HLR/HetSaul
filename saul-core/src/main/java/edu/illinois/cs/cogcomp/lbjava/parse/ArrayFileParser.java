...
public class ArrayFileParser implements Parser
{
   ...
   **/
  public ArrayFileParser(String exampleFile) { this(exampleFile, false); }
  ...
  /**
    * Returns either an <code>Object[]</code> or a {@link edu.illinois.cs.cogcomp.lbjava.parse.FoldSeparator}
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println(
"usage: java edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser <example file> <lexicon file> <lc file>");
      System.exit(1);
    }
