 ...
 *     <td>
 *       Names for every {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierExpression} are computed.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.InstanceCreationExpression}s creating outer classes, and
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.Name}s known to refer to classifiers, the latter two only to
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.SenseStatement#value value} to the
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.SenseStatement#name name} variable in the
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.SenseStatement} object, and the
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.SenseStatement#value value} variable gets a new
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.Constant} representing <code>"true"</code> if the generator
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.Block}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 *     <td align=right>A8</td>
 *     <td>
 *       The dependor graph, linking the names of {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}s with
 *       the names of other {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}s that depend on them, is
 *       built for use by {@link edu.illinois.cs.cogcomp.lbjava.RevisionAnalysis}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 *     <td align=right>A9</td>
 *     <td>
 *       The invoked graph, linking the names of {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}s with
 *       the names of other {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}s that are invoked by them,
 *       is built for use by {@link edu.illinois.cs.cogcomp.lbjava.TranslateToJava}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *     <td>
 *       If a {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} does not have a
 ...
 *     <td>
 *       Flags are set in each {@link edu.illinois.cs.cogcomp.lbjava.IR.ConstraintEqualityExpression}
 ...
 *     <td>
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.Name}s and every {@link edu.illinois.cs.cogcomp.lbjava.IR.ASTNode} that represents a new local
 ...
 *     <td>
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.Argument} types in arguments of quantifier expressions are
 *       marked as such.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *     <td>
 *       Quantified {@link edu.illinois.cs.cogcomp.lbjava.IR.ConstraintEqualityExpression}s,
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.ConstraintInvocation}s, and
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.QuantifiedConstraintExpression}s are marked as such.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 *     <td align=right>A16</td>
 *     <td>
 *       If a {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceDeclaration} does not have a <code>with</code>
 ...
 *     <td>
 *       When a {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierName} is not alone on the right hand side of
 *       a {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierAssignment}, its {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierName#name name}
 *       is set equal to its {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierName#referent referent}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 *     <td align=right>A18</td>
 *     <td>
 *       The {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierExpression#cacheIn} member variable is set when
 *       the containing {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierAssignment} had a
 ...
 *     <td>
 *       The {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierExpression#comment} field of each top level
 *       classifier expression is set to the comment of the containing
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierAssignment}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.InstanceCreationExpression} as an argument,
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression#learnerName} is set to the name
 ...
 *     <td>
 *       The value of {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierAssignment#singleExampleCache} is
 *       propagated from {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierAssignment}s to
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierExpression}s.
 *     </td>
 *   </tr>
 * </table>
 *
 ...
 *     <td>
 *       The input type of a {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierName} is checked for
 *       appropriateness in its context.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *     <td>
 *       The {@link edu.illinois.cs.cogcomp.lbjava.IR.InstanceCreationExpression} in the <code>from</code>
 *       clause of a {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} instantiates a
 *       {@link edu.illinois.cs.cogcomp.lbjava.parse.Parser}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 *     <td align=right>B6</td>
 *     <td>
 *       The {@link edu.illinois.cs.cogcomp.lbjava.IR.InstanceCreationExpression} in the <code>with</code>
 *       clause of a {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} instantiates a
 *       {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 *     <td align=right>B7</td>
 *     <td>
 *       The {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner} specified in a
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} must have input type
 ...
 *     <td>
 *       Every {@link edu.illinois.cs.cogcomp.lbjava.IR.ReferenceType} must successfully locate the Java
 ...
 *     <td>
 *       A {@link edu.illinois.cs.cogcomp.lbjava.IR.CodedClassifier} may not be declared as
 *       <code>mixed%</code>.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceInvocation} must refer to an inference.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceInvocation} must refer to a discrete learner.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceInvocation} is checked for appropriateness in its
 *       context.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *     <td>
 *       The inference of an {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceInvocation} must contain an
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceDeclaration.HeadFinder} whose input type is
 *       the same as the input type of the {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceInvocation}'s
 *       argument learner.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       the name of a {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       instantiate a {@link edu.illinois.cs.cogcomp.lbjava.learn.Normalizer}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 *     <td align=right>B29</td>
 *     <td>
 *       An {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceDeclaration} must contain at least one head
 *       finder method.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *     <td>
 *       An {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceDeclaration} must contain exactly one
 ...
 *     <td>
 *       An {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceDeclaration} may contain no more than one
 ...
 *     <td>
 *       The {@link edu.illinois.cs.cogcomp.lbjava.IR.InstanceCreationExpression} in the <code>with</code>
 *       clause of an {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceDeclaration} instantiates a
 *       {@link edu.illinois.cs.cogcomp.lbjava.infer.Inference}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression}'s <code>from</code> clause must
 *       be an integer.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} must be an integer.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} must be a double.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *       {@link edu.illinois.cs.cogcomp.lbjava.IR.ReferenceType} or type {@link edu.illinois.cs.cogcomp.lbjava.IR.ArrayType}.
 *     </td>
 *   </tr>
 *   <tr valign=top>
 ...
 *     <td>
 *       The {@link edu.illinois.cs.cogcomp.lbjava.IR.InstanceCreationExpression} in the <code>testFrom</code>
 *       clause of a {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} instantiates a
 *       {@link edu.illinois.cs.cogcomp.lbjava.parse.Parser}.
 *     </td>
 *   </tr>
 ...
 * </table>
 *
 * @see    edu.illinois.cs.cogcomp.lbjava.RevisionAnalysis
 * @see    edu.illinois.cs.cogcomp.lbjava.parse.Parser
 * @see    edu.illinois.cs.cogcomp.lbjava.learn.Learner
 * @see    edu.illinois.cs.cogcomp.lbjava.learn.Normalizer
 * @see    edu.illinois.cs.cogcomp.lbjava.infer.Inference
 * @author Nick Rizzolo
 **/
public class SemanticAnalysis extends Pass
{
	// Static variables.
	/**
	 * The keys of this map are the names of {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}s; the values
	 * are <code>HashSet</code>s of names of other locally defined
	 * {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}s that depend on the {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator} named by
	 * the associated key.  The dependor graph has an entry for every
	 * {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator} in the source.
	 **/
	 ...
	 * defined) {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}s that are invoked within the
	 * {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator} named by the associated key.  The invoked graph
	 * does not necessarily have an entry for every {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator} in
	 * the source.
	 **/
	public static HashMap<String, HashSet<String>> invokedGraph;
	/**
	 * The keys of this map are the names of {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier}s; the values
	 * are {@link edu.illinois.cs.cogcomp.lbjava.IR.ASTNode}s representing the source code implementations of the
	 * associated {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier}s.  This table has an entry for every
	 * {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier} in the source.
	 **/
	 ...
	 * Use this method to determine if one {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator} depends on
	 * another either directly or indirectly.
	 *
	 * @param c1 One {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}.
	 * @param c2 The other {@link edu.illinois.cs.cogcomp.lbjava.CodeGenerator}.
	...
	public static boolean isDependentOn(String c1, String c2) {
		...
		while (queue.size() > 0) {
			...
			visited.add(c);
			for (Iterator<String> I = dependorGraph.get(c).iterator();
					I.hasNext(); ) {
				c = I.next();
	...
	private static void printGraph(HashMap<String, HashSet<String>> graph) {
		...
		for (int i = 0; i < keys.length; ++i) {
			...
			String[] edges =
					(String[]) graph.get(keys[i]).toArray(new String[0]);
	 ...
	 * {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierAssignment} they are contained in.
	 **/
	 ...
	 * {@link edu.illinois.cs.cogcomp.lbjava.IR.QuantifiedConstraintExpression}s they are.
	 **/
	...
	/**
	 * Instantiates a pass that runs on an entire {@link edu.illinois.cs.cogcomp.lbjava.IR.AST}.
	 *
	...
	public void run(LearningClassifierExpression lce) {
		...
		weka = lce.learnerName.equals(new Name("WekaWrapper"))
				|| lce.learnerName.equals(new Name("edu.illinois.cs.cogcomp.lbjava.learn.WekaWrapper"));
