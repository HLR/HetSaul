...
/**
  ...
  * extends {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner}.  Every learning classifier specified in an LBJ
...
public class LearnerToText
{
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("usage: java edu.illinois.cs.cogcomp.lbjava.learn.LearnerToText <learner>");
      System.exit(1);
    }
