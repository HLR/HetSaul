...
public class AdaBoost extends Learner
{
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.AdaBoost.Parameters} object.
    *
  ...
  /**
    * A container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.AdaBoost}'s configurable parameters.
