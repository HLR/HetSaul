...
/**
 * After code has been generated with {@link edu.illinois.cs.cogcomp.lbjava.TranslateToJava}, this pass
 * trains any classifiers for which training was indicated.
 *
 * @see    edu.illinois.cs.cogcomp.lbjava.TranslateToJava
 * @author Nick Rizzolo
 **/
public class Train extends Pass
{
	 ...
	 * {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression} for which new code was generated.
	 **/
	 ...
	 * traverse children of {@link edu.illinois.cs.cogcomp.lbjava.IR.CodedClassifier}s, so this method exists
	 ...
	 * Runs this pass on all nodes of the indicated type.  There's no reason to
	 * traverse children of {@link edu.illinois.cs.cogcomp.lbjava.IR.ConstraintDeclaration}s, so this method
	 ...
	 * Runs this pass on all nodes of the indicated type.  There's no reason to
	 * traverse children of {@link edu.illinois.cs.cogcomp.lbjava.IR.InferenceDeclaration}s, so this method
	 * exists simply to stop that from happening.
	 *
	...
	/** <!-- increment(int[],int[]) -->
	 * Helps the {@link edu.illinois.cs.cogcomp.lbjava.Train.TrainingThread#getParameterCombinations()} method
	...
	protected class TrainingThread extends Thread
	{
		 ...
		 * according to {@link edu.illinois.cs.cogcomp.lbjava.RevisionAnalysis}, it means only the label lexicon
		 ...
		 * Uses the various {@link edu.illinois.cs.cogcomp.lbjava.IR.ParameterSet ParameterSet}s in the AST
		 * to generate an array of parameter combinations representing the cross
		 * product of all {@link edu.illinois.cs.cogcomp.lbjava.IR.ParameterSet ParameterSet}s except the
		 * one in the {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression#rounds} field, if any.
		 **/
		 ...
		 * under the assumption that {@link edu.illinois.cs.cogcomp.lbjava.IR.ParameterSet}s were present.
