...
/**
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#labeler} is a single discrete classifier whose returned
  ...
  * value returned from {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier#allowableValues()} is
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWinnow.Parameters Parameters} as input.  The
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWinnow.Parameters Parameters} class indicates the
...
public class SparseWinnow extends LinearThresholdUnit
{
  ...
  /** Default for {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold}. */
  public static final double defaultThreshold = 16;
  /** Default for {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#initialWeight}. */
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold} take default values, while the
  ...
  /**
    ...
    * {@link #learningRate}, and the {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold}
  ...
  /**
    ...
    * and the {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold} takes the default, while
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold} to the specified values, while the
    * name of the classifier gets the empty string.
    *
    * @param a  The desired value of the promotion parameter.
    * @param b  The desired value of the demotion parameter.
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector}, while the name of the classifier gets the
    * empty string.
    *
    * @param a  The desired value of the promotion parameter.
    * @param b  The desired value of the demotion parameter.
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWinnow.Parameters} object.
    *
  ...
  /**
    * {@link #learningRate}, {@link #beta}, and
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold} take default values.
    *
  ...
  /**
    * Sets {@link #learningRate} and {@link #beta} to the specified values,
    * and the {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold} takes the default.
    *
    * @param n  The name of the classifier.
    * @param a  The desired value of the promotion parameter.
    * @param b  The desired value of the demotion parameter.
  ...
  /**
    * Sets {@link #learningRate}, {@link #beta}, and
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold} to the specified values.
    *
    * @param n  The name of the classifier.
    * @param a  The desired value of the promotion parameter.
    * @param b  The desired value of the demotion parameter.
  ...
  /**
    * Use this constructor to specify an alternative subclass of
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector}.
    *
    * @param n  The name of the classifier.
    * @param a  The desired value of the promotion parameter.
    * @param b  The desired value of the demotion parameter.
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#negativeThickness}, and finally
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#bias}.
    *
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWinnow}'s configurable
