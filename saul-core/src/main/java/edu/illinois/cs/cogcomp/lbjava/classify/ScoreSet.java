...
/**
  ...
  *
  * @see edu.illinois.cs.cogcomp.lbjava.classify.Score
  * @author Nick Rizzolo
 **/
public class ScoreSet implements Cloneable
{
  ...
  /**
    * Retrieves the {@link edu.illinois.cs.cogcomp.lbjava.classify.Score} object associated with the given
    * classification value.
    *
    * @param v  The classification value.
    * @return The associated {@link edu.illinois.cs.cogcomp.lbjava.classify.Score} object.
   **/
