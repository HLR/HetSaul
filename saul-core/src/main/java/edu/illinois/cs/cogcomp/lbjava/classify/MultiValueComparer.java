...
/**
  ...
  * This behavior differs from that of {@link edu.illinois.cs.cogcomp.lbjava.classify.ValueComparer} because it does
...
public class MultiValueComparer extends ValueComparer
{
  ...
  /**
    * Returns a Boolean feature (with value "true" or "false") indicating
    * whether the output of {@link edu.illinois.cs.cogcomp.lbjava.classify.ValueComparer#labeler} applied to the
    * argument object contained the feature value referenced by
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.ValueComparer#value}.
    *
  ...
  /**
    ...
    * acts as a pointer into {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscreteFeature#BooleanValues}.
    *
    * @param o  The object to classify.
