...
/**
  ...
  *             superceded by {@link edu.illinois.cs.cogcomp.lbjava.parse.ArrayFileParser}.
 **/
public class FeatureVectorParser implements Parser
{
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println(
  "usage: java edu.illinois.cs.cogcomp.lbjava.parse.FeatureVectorParser <example file> <lexicon file>");
      System.exit(1);
    }
