...
/**
  * This classifier expects a {@link edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector} as input, and it returns
  * the contents of its {@link edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector#labels labels} list in a new
  * {@link edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector} as output.
  *
  * @author Nick Rizzolo
 **/
