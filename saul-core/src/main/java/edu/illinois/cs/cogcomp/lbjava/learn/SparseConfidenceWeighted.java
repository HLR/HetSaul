...
/**
  ...
  * {@link classify.Classifier#allowableValues()} method.  The second
  * value returned from {@link Classifier#allowableValues()} is
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseConfidenceWeighted.Parameters Parameters} as
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseConfidenceWeighted.Parameters Parameters} class
...
public class SparseConfidenceWeighted extends LinearThresholdUnit
{
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#weightVector} parameters.
    *
    * @param c  The desired confidence value.
    * @param v  The desired initial variance.
    * @param vm An empty sparse weight vector of means, perhaps of an
    *           alternative subclass of {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector}.
   **/
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#weightVector}, and {@link #variances}
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseConfidenceWeighted.Parameters} object.
    *
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#weightVector} and the annotation <code>End
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseConfidenceWeighted}'s
  ...
  public static class Parameters extends LinearThresholdUnit.Parameters
  {
    /**
      * The confidence parameter as described above; default
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseConfidenceWeighted#defaultConfidence}.
     **/
    protected double confidence;
    /**
      * The strictly positive initial variance of the parameters; default
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseConfidenceWeighted#defaultInitialVariance}.
     **/
    protected double initialVariance;
    /**
      * The current variances of the parameters; default
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#defaultWeightVector}.
     **/
    protected SparseWeightVector variances;
