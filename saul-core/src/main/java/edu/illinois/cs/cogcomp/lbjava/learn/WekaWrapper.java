...
public class WekaWrapper extends Learner
{
  ...
  /**
    ...
    * default is <code>weka.classifiers.bayes.NaiveBayes</code>.
   **/
  ...
  /**
    ...
    * algorithm: <code>weka.classifiers.bayes.NaiveBayes</code>.  Attribute
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.WekaWrapper.Parameters} object.
    *
  ...
  /**
    ...
    * learning algorithm: <code>weka.classifiers.bayes.NaiveBayes</code>.
    *
    * @param n                The name of the classifier.
    * @param attributeString  The string describing the types of attributes
    *                         example objects will have.
  ...
  /**
    * Creates a WEKA Instance object out of a {@link edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector}.
   **/
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.WekaWrapper}'s configurable
  ...
  public static class Parameters extends Learner.Parameters
  {
    /**
      * Stores the instance of the WEKA classifier which we are training;
      * default {@link edu.illinois.cs.cogcomp.lbjava.learn.WekaWrapper#defaultBaseClassifier}.
     **/
    public weka.classifiers.Classifier baseClassifier;
    /**
      * A string encoding of the return types of each of the feature
      * extractors in use; default {@link edu.illinois.cs.cogcomp.lbjava.learn.WekaWrapper#defaultAttributeString}.
     **/
