...
/**
  ...
  * expressions except for {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierName}s and
  * {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression}s.
  *
  * @author Nick Rizzolo
 **/
public class ClassifierCSE extends Pass
{
  ...
  /**
    ...
    * a new {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierName} if there was a name associated with it or
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.IR.ClassifierName}s are excluded from the map since they are already
    * merely names.  {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression}s are also excluded,
