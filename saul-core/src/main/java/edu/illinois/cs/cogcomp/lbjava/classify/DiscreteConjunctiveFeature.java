...
public class DiscreteConjunctiveFeature extends DiscreteFeature
{
  ...
  /**
    ...
    *
    * @return {@link edu.illinois.cs.cogcomp.lbjava.util.ByteString#emptyString}, since conjunctive features don't
    *         have identifiers.
   **/
  ...
  /**
    * A helper method for {@link #getFeatureKey(edu.illinois.cs.cogcomp.lbjava.learn.Lexicon,boolean,int)}, this
  ...
  /**
    * Returns a {@link edu.illinois.cs.cogcomp.lbjava.classify.RealConjunctiveFeature} with exactly the same children
    * as this feature.
   **/
  ...
  /**
    ...
    * of when removing a feature of this type from a {@link edu.illinois.cs.cogcomp.lbjava.learn.ChildLexicon}, in
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.ChildLexicon}.
    *
