...
/**
  ...
  *
  * @see    edu.illinois.cs.cogcomp.lbjava.nlp.Sentence
  * @author Nick Rizzolo
 **/
public class SentenceSplitter extends LineByLine
{
  ...
  /**
    ...
    *
    * <p> Usage:
    * <code> java edu.illinois.cs.cogcomp.lbjava.nlp.SentenceSplitter &lt;file name&gt; </code>
    *
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("usage: java edu.illinois.cs.cogcomp.lbjava.nlp.SentenceSplitter <file name>");
      System.exit(1);
    }
