 ...
 * {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s are associated with <code>Double</code>s and/or with
...
public class SparseWeightVector implements Cloneable, Serializable
{
	...
	/** The weights in the vector indexed by their {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon} key. */
	 ...
	 * to a stream just like {@link #write(java.io.PrintStream)}, but without the
	 ...
	 * {@link #write(java.io.PrintStream)}.
	 *
	 ...
	 * Creates a string representation of this <code>SparseWeightVector</code>.
	 * This method merely returns the data computed by
	 * {@link #write(java.io.PrintStream, edu.illinois.cs.cogcomp.lbjava.learn.Lexicon)}.
	 *
	 * @param lex  The feature lexicon.
	 * @return A textual representation of this vector.
	 **/
