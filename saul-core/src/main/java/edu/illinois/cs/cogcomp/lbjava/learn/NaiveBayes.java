...
/**
  ...
  *
  * <p> This {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner} learns a <code>discrete</code> classifier from
  ...
  * {@link NaiveBayesTest.NaiveBayes.Parameters Parameters} as input.  The
  ...
  * {@link NaiveBayesTest.NaiveBayes.Parameters Parameters} class indicates the
  * default value of the parameter when using the latter type of constructor.
  *
  * @see    edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes.NaiveBayesVector
  * @author Nick Rizzolo
 **/
public class NaiveBayes extends Learner
{
  ...
  /** One {@link edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes.NaiveBayesVector} for each observed prediction value. */
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes.Parameters} object.
    *
  ...
  /**
    * The scores in the returned {@link edu.illinois.cs.cogcomp.lbjava.classify.ScoreSet} are the posterior
  ...
  /**
    ...
    * instead of a {@link edu.illinois.cs.cogcomp.lbjava.classify.FeatureVector}.
    *
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes}'s configurable
  ...
  public static class Parameters extends Learner.Parameters
  {
    /**
      ...
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes#defaultSmoothing}.
     **/
  ...
  /**
    ...
    * Features are associated with {@link edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes.Count}s.  Those not
    ...
    *
    * <p> {@link edu.illinois.cs.cogcomp.lbjava.classify.RealFeature}s' strengths are ignored by this vector; they are
  ...
  {
    /** The counts in the vector indexed by their {@link edu.illinois.cs.cogcomp.lbjava.learn.Lexicon} key. */
    ...
    /** Simply instantiates {@link edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes.NaiveBayesVector#counts}. */
    ...
    /**
      ...
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector} except that
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.NaiveBayes.NaiveBayesVector#incrementCount(int,double)}
      * is called instead of
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector#setWeight(int,double)}.
      *
      * @param exampleFeatures  The example's array of feature indices.
      * @param exampleValues    The example's array of feature values.
    ...
    /**
      * This method is similar to the implementation in
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector} except that the <code>defaultW</code>
    ...
    /**
      ...
      * method is equivalent to that of {@link #write(java.io.PrintStream, edu.illinois.cs.cogcomp.lbjava.learn.Lexicon)}.
      *
    ...
    /**
      ...
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector#write(edu.illinois.cs.cogcomp.lbjava.util.ExceptionlessOutputStream)} and does
      * not output its class name or the contents of
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector#weights} since there shouldn't be any.
      *
      * @param out  The output stream.
     **/
    public void write(ExceptionlessOutputStream out) {
