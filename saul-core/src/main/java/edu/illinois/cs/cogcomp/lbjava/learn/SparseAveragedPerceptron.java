...
/**
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier#classify(Object)} or
  * {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier#discreteValue(Object)}.
  *
  * <p> The above description is a useful way to think about the operation of
  * this {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner}.  However, the user should note that this
  ...
  *
  * <p> It is assumed that {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#labeler} is a single discrete
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier#allowableValues()} method.  The second value returned
  * from {@link edu.illinois.cs.cogcomp.lbjava.classify.Classifier#allowableValues()} is treated as "positive", and it
...
{
  /** Default for {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#weightVector}. */
  public static final AveragedWeightVector defaultWeightVector =
    new AveragedWeightVector();

  /**
    * Holds the same reference as {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#weightVector}
    * casted to {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseAveragedPerceptron.AveragedWeightVector}.
   **/
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseAveragedPerceptron.Parameters} object.
    *
    * @param p  The settings of all parameters.
   **/
  public SparseAveragedPerceptron(Parameters p) {
    this("", p);
  }
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#learn(int[],double[],int[],double[])}, except
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparsePerceptron#learningRate},
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#initialWeight},
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#threshold},
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#positiveThickness},
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#negativeThickness},
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit#bias}, and finally {@link #averagedBias}.
    *
  ...
  /**
    * Simply a container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseAveragedPerceptron}'s
    ...
    * object referenced by {@link edu.illinois.cs.cogcomp.lbjava.learn.LinearThresholdUnit.Parameters#weightVector}
    * is replaced via an instance of this class, it must be replaced with an
    * {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseAveragedPerceptron.AveragedWeightVector}.
    *
    * @author Nick Rizzolo
   **/
  ...
  /**
    ...
    * <code>double</code>s with each {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}.  The first plays the
  ...
  {
    /**
      * Together with {@link edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector#weights}, this vector provides
    ...
    /**
      ...
      * by {@link #write(edu.illinois.cs.cogcomp.lbjava.util.ExceptionlessOutputStream)}.
      *
      * @param in The input stream.
     **/
    public void read(ExceptionlessInputStream in) {
