...
public class ByteString implements Cloneable, Comparable
{
  ...
  /**
    ...
    * {@link #lexWrite(edu.illinois.cs.cogcomp.lbjava.util.ExceptionlessOutputStream, edu.illinois.cs.cogcomp.lbjava.util.ByteString)}.
    *
    * @param in The input stream.
  ...
  /**
    ...
    * ({@link #append(String)}, {@link #append(edu.illinois.cs.cogcomp.lbjava.util.ByteString)}, and
