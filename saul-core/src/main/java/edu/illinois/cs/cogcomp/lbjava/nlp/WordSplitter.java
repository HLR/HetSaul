...
/**
  * This parser takes the plain, unannotated {@link edu.illinois.cs.cogcomp.lbjava.nlp.Sentence}s returned by
  * another parser (e.g., {@link edu.illinois.cs.cogcomp.lbjava.nlp.SentenceSplitter}) and splits them into
  * {@link edu.illinois.cs.cogcomp.lbjava.nlp.Word} objects.  Entire sentences now represented as
...
public class WordSplitter implements Parser
{
  /**
    ...
    *
    * <p> Usage:
    * <code> java edu.illinois.cs.cogcomp.lbjava.nlp.WordSplitter &lt;file name&gt; </code>
    *
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("usage: java edu.illinois.cs.cogcomp.lbjava.nlp.WordSplitter <file name>");
      System.exit(1);
    }
  ...
  /** The {@link edu.illinois.cs.cogcomp.lbjava.nlp.Sentence} returning parser. */
  ...
  /**
    ...
    *
    * @param p  The {@link edu.illinois.cs.cogcomp.lbjava.nlp.Sentence} returning parser.
   **/
  public WordSplitter(Parser p) { parser = p; }


  /**
    * Returns {@link edu.illinois.cs.cogcomp.lbjava.parse.LinkedVector}s of {@link edu.illinois.cs.cogcomp.lbjava.nlp.Word} objects one at
    * a time.
   **/
  public Object next() {
