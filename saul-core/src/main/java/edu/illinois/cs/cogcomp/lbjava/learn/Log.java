...
/**
  * Simply turns each score <i>s</i> in the {@link edu.illinois.cs.cogcomp.lbjava.classify.ScoreSet} returned by the
  * specified {@link edu.illinois.cs.cogcomp.lbjava.learn.Normalizer} into <i>log(s)</i>.
  *
  * @author Nick Rizzolo
 **/
