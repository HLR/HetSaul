...
/**
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscretePrimitiveFeature}, however its {@link #value} is stored as
  * a <code>String</code> instead of a {@link edu.illinois.cs.cogcomp.lbjava.util.ByteString}.  Discrete
  * classifiers return features of this type (or
  * {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscreteConjunctiveFeature}s or {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscreteReferringFeature}s
  * that contain features of this type).  Before storing these features in a
  * lexicon, however, they are converted to {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscretePrimitiveFeature}s
...
public class DiscretePrimitiveStringFeature extends DiscreteFeature
{
  ...
  /**
    ...
    *
    * @see edu.illinois.cs.cogcomp.lbjava.classify.Feature#readFeature(edu.illinois.cs.cogcomp.lbjava.util.ExceptionlessInputStream)
   **/
  ...
  /**
    * Returns a {@link edu.illinois.cs.cogcomp.lbjava.classify.RealPrimitiveFeature} whose
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.RealPrimitiveFeature#value value} field is set to the strength of
  ...
  /**
    ...
    * {@link #lexWrite(edu.illinois.cs.cogcomp.lbjava.util.ExceptionlessOutputStream, edu.illinois.cs.cogcomp.lbjava.learn.Lexicon,String,String,String,String, edu.illinois.cs.cogcomp.lbjava.util.ByteString)}.
    *
    * @param in   The input stream.
