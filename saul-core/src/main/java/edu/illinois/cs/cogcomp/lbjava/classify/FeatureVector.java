...
public class FeatureVector implements Cloneable, Serializable
{
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.RealFeature}s with appropriate strengths.  Otherwise, the
    ...
    *         features have been converted to {@link edu.illinois.cs.cogcomp.lbjava.classify.RealFeature}s.
   **/
  ...
  /**
    ...
    *         {@link edu.illinois.cs.cogcomp.lbjava.classify.RealFeature}s in this vector.
   **/
  ...
  /**
    ...
    *         from this vector, or <code>null</code> if there are any
    *         {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscreteFeature}s in this vector.
   **/
  ...
  */
  ...
  /**
    ...
    * features and labels, as defined by {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature} equivalence.
    *
  ...
  /**
    ...
    * same number of {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s and if the values of those
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature}s are pair-wise equivalent according to the
    * {@link edu.illinois.cs.cogcomp.lbjava.classify.Feature#valueEquals(String)} method.
    *
