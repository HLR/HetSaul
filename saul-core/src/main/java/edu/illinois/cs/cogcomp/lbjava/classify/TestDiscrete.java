...
public class TestDiscrete
{
  ...
  /**
    ...
    * interface to
    * {@link #testDiscrete(edu.illinois.cs.cogcomp.lbjava.classify.TestDiscrete, edu.illinois.cs.cogcomp.lbjava.classify.Classifier, edu.illinois.cs.cogcomp.lbjava.classify.Classifier, edu.illinois.cs.cogcomp.lbjava.parse.Parser,boolean,int)}
  ...
  private static TestDiscrete instantiate(String[] args) {
    ...
    try {
      ...
      System.err.println(
      "usage:\n"
    + "  java edu.illinois.cs.cogcomp.lbjava.classify.TestDiscrete [-t <n>] <classifier> <oracle> \\\n"
    + "                                  <parser> <input file> \\\n"
