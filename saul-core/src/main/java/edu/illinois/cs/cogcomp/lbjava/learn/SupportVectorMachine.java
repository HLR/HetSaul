...
/**
  ...
  * is assumed that {@link edu.illinois.cs.cogcomp.lbjava.learn.Learner#labeler} is a single discrete classifier
  ...
  * {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine.Parameters Parameters} as input.
...
public class SupportVectorMachine extends Learner
{
  ...
  /**
    ...
    * settings in the {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine.Parameters} object.
  ...
  /**
    ...
    * <code>liblinear.Linear.train()</code> for training.
    *
  ...
  public void doneLearning() {
    ...
    de.bwaldvogel.liblinear.Model trainedModel = de.bwaldvogel.liblinear.Linear.train(prob, params);
  ...
  /**
    ...
    * method.  Returns a {@link edu.illinois.cs.cogcomp.lbjava.classify.DiscretePrimitiveStringFeature} set to the
    * label value.
    *
    * @param exampleFeatures  The example's array of feature indices
    * @param exampleValues    The example's array of feature values
  ...
  /**
    ...
    * must contain only {@link edu.illinois.cs.cogcomp.lbjava.util.ByteString}s.
    *
    * @param example    The example object.
  ...
  /**
    ...
    * {@link #valueOf(int[],double[], java.util.Collection)} when the labeler is known to
  ...
  /**
    * A container for all of {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine}'s configurable
  ...
  public static class Parameters extends Learner.Parameters
  {
    /**
      ...
      * {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine#defaultSolverType}.
      *
      * <p> Possible values:
      * <ul>
    ...
    /**
      * The cost parameter C; default {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine#defaultC}
     **/
    public double C;
    /**
      * The tolerance of termination criterion;
      * default {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine#defaultEpsilon}.
     **/
    public double epsilon;
    /**
      * If {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine#bias} &gt;= 0, an instance vector x
      * becomes [x; bias]; otherwise, if {@link edu.illinois.cs.cogcomp.lbjava.learn.SupportVectorMachine#bias}
    ...
    /**
      ...
      * into a <code>liblinear.SolverType</code> object to be used
