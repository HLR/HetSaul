...
public class ParameterSet extends Expression
{
  ...
  /**
    ...
    * <code>rounds</code> clause of a {@link edu.illinois.cs.cogcomp.lbjava.IR.LearningClassifierExpression}.
   **/
  ...
  /**
    ...
    * {@link #increment} expressions (which must represent {@link edu.illinois.cs.cogcomp.lbjava.IR.Constant}s
    * of a {@link edu.illinois.cs.cogcomp.lbjava.IR.PrimitiveType} other than <code>boolean</code>) into an
  ...
  /**
    ...
    * {@link edu.illinois.cs.cogcomp.lbjava.IR.Constant}, this method produces an array of <code>String</code>s
