...
public class OLINK {
    ...
    @XmlAttribute(name = "frame_type", required = true)
    ...
    @XmlAttribute(name = "projective", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected String projective;
    @XmlAttribute(name = "referencePt", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected String referencePt;
    ...
    /**
     * Gets the value of the projective property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getProjective() {
        return projective;
    }

    /**
     * Sets the value of the projective property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setProjective(String value) {
        this.projective = value;
    }

    /**
     * Gets the value of the referencePt property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getReferencePt() {
        return referencePt;
    }

    /**
     * Sets the value of the referencePt property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setReferencePt(String value) {
        this.referencePt = value;
    }
